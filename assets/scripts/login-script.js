...
/** 
 * Membuat variabel expectedEmail untuk menyimpan informasi password sementara.
 * @constant {string}
 */
...
loginFormElement.addEventListener('submit', function(event) {
  ...
  */
  ...
  /* Comment : memastikan bahwa nila email dan password sesuai dengan nilai yang tersimpan.*/
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment : Namun jika tidak sesua maka akan menampilkan informasi bahwa input salah. */
    showPopUp();
